...
var app = (function () {
    ...
    function create_fragment$4(ctx) {
    	...
    	const block = {
    		c: function create() {
    			div = element("div");
    			span0 = element("span");
    			span0.textContent = "Mehmet's To-Do List";
    			t1 = space();
    			span1 = element("span");
    			t2 = text(/*completedItemsLength*/ ctx[0]);
    			t3 = text("/");
    			t4 = text(/*allItemsLength*/ ctx[1]);
    			attr_dev(span0, "class", "svelte-1egrvla");
    			add_location(span0, file$4, 8, 4, 208);
    			attr_dev(span1, "class", "svelte-1egrvla");
    			add_location(span1, file$4, 9, 4, 245);
    			attr_dev(div, "class", "header svelte-1egrvla");
    			add_location(div, file$4, 7, 0, 183);
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*completedItemsLength*/ 1) set_data_dev(t2, /*completedItemsLength*/ ctx[0]);
    			if (dirty & /*allItemsLength*/ 2) set_data_dev(t4, /*allItemsLength*/ ctx[1]);
    		},
    		i: noop,
    		o: noop,
    ...
    function instance$4($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ('completedItemsLength' in $$props) $$invalidate(0, completedItemsLength = $$props.completedItemsLength);
    		if ('allItemsLength' in $$props) $$invalidate(1, allItemsLength = $$props.allItemsLength);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$items*/ 4) {
    			$$invalidate(1, allItemsLength = $items.length);
    		}

    		if ($$self.$$.dirty & /*$items*/ 4) {
    			$$invalidate(0, completedItemsLength = $items.filter(item => item.completed).length);
    		}
    	};

    	return [completedItemsLength, allItemsLength, $items];
    }
    ...
    /* src/components/Item.svelte generated by Svelte v3.46.4 */
    ...
    function create_fragment$3(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input0, "class", "text-input svelte-1cw3pa6");
    			input0.readOnly = /*completed*/ ctx[1];
    			add_location(input0, file$3, 21, 4, 496);
    			attr_dev(input1, "type", "checkbox");
    			attr_dev(input1, "name", "list-checkbox");
    			attr_dev(input1, "class", "completed-checkbox svelte-1cw3pa6");
    			add_location(input1, file$3, 29, 4, 725);
    			attr_dev(div, "class", "item svelte-1cw3pa6");
    			toggle_class(div, "completed", /*completed*/ ctx[1]);
    			add_location(div, file$3, 20, 0, 426);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					...
    					listen_dev(div, "dblclick", /*handleDeleteItem*/ ctx[3], false, false, false)
    				];
    ...
    /* src/components/NewItem.svelte generated by Svelte v3.46.4 */
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(input, "class", "svelte-1jdv30o");
    			add_location(input, file$2, 15, 0, 299);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		m: function mount(target, anchor) {
    			...
    			if (!mounted) {
    				dispose = [
    					listen_dev(input, "keyup", /*handleUpKey*/ ctx[1], false, false, false),
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	return [value, handleUpKey, input_input_handler];
    }
    ...
    function create_else_block(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(p, "class", "list-status svelte-bx3evn");
    			add_location(p, file$1, 55, 8, 1367);
    		},
    		m: function mount(target, anchor) {
    ...
    // (53:4) {#each itemSorted as item (item)}
    function create_each_block(key_1, ctx) {
    	...
    	const block = {
    		...
    		p: function update(new_ctx, dirty) {
    			...
    			const item_changes = (dirty & /*itemSorted*/ 1)
    	...
    	dispatch_dev("SvelteRegisterBlock", {
    		...
    		type: "each",
    		source: "(53:4) {#each itemSorted as item (item)}",
    		ctx
    	});
    ...
    function create_fragment$1(ctx) {
    	...
    	let each_value = /*itemSorted*/ ctx[0];
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "list-container svelte-bx3evn");
    			add_location(div, file$1, 50, 0, 1160);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    		...
    		p: function update(ctx, [dirty]) {
    			if (dirty & /*itemSorted, handleUpdate, handleDelete*/ 13) {
    				each_value = /*itemSorted*/ ctx[0];
    				validate_each_argument(each_value);
    				group_outros();
    				validate_each_keys(ctx, each_value, get_each_context, get_key);
    ...
    function instance$1($$self, $$props, $$invalidate) {
    	...
    	$$self.$inject_state = $$props => {
    		if ('itemSorted' in $$props) $$invalidate(0, itemSorted = $$props.itemSorted);
    	};
    	...
    	$$self.$$.update = () => {
    		if ($$self.$$.dirty & /*$items, itemSorted*/ 17) {
    			{
    				$$invalidate(0, itemSorted = [...$items]);
    	...
    	return [itemSorted, handleNewItem, handleUpdate, handleDelete, $items];
    }
